    ...
    <div class="col-lg-12">
        ...
        <div class="row">
            <div class="clearfix">  
                ...
                <div class="col-lg-2">
                    <h1 class="pull-left">
                        <?= $this->Html->image('pipeline/' . h($pipeline['Pipeline']['logo'])); ?>
                        <?= h($pipeline['Pipeline']['name']); ?>
                    </h1>
                </div>
                <div class="col-lg-5">
                    ...
                    <div class="main-box-body clearfix stage-<?php echo count($stages); ?>">
                            ...
                            <div class="stage-div">
                                ...
                                <div class="stage-name">
                                    ...
                                    <h2 style="background-color:<?= h($stage['Stage']['color']); ?>"><?= h($stage['Stage']['name']); ?></h2>
                                    <div class="stage-name-after" style="border-left-color:<?= h($stage['Stage']['color']); ?>"></div>
                                </div>
                                <!--End Stage Box Title-->
                                <!--Stage Box Content-->
