        ...
        <div class="modal-content">
            ...
            <div class="modal-body">													
                ...
                <div class="form-group" data-toggle="buttons">
                    ...
                    <label class="btn"><i class="fa fa-archive"></i><input type="radio" name="data[Label][icon]" value="fa fa-archive"></label>
                    <label class="btn"><i class="fa fa-android"></i><input type="radio" name="data[Label][icon]" value="fa fa-android"></label>
                    <label class="btn"><i class="fa fa-beer"></i><input type="radio" name="data[Label][icon]" value="fa fa-beer"></label>
                    <label class="btn"><i class="fa fa-behance"></i><input type="radio" name="data[Label][icon]" value="fa fa-behance"></label>
                    <label class="btn"><i class="fa fa-barcode"></i><input type="radio" name="data[Label][icon]" value="fa fa-barcode"></label>
                    <label class="btn"><i class="fa fa-car"></i><input type="radio" name="data[Label][icon]" value="fa fa-car"></label>
